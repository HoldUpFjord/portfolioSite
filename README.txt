This was my first attempt at a personal site. The main page is a tempelate used from HTML5up: "https://html5up.net/hyperspace". The intent is to be a forward facing freelance web design page, with a secondary page for dev roles.

Working with a existing codebase like this allowed me to examine and play fiddle with a lot of CSS I hadn't encountered or worked with until that point. Some examples are  psuedocode such as before::/after::, dealing with inheritance and stylizations, and tinkering with the overall design and anchortags.
